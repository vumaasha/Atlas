...
class Shannoh:
    def __init__(self):
        ...
        self.source_urls_col = 'shannoh'  # Column name having the source URL's in CSV file
    ...
    def parse_product(self,each_url,taxonomy):
        try:
            ...
            web_image_url = self.driver.find_elements_by_css_selector('div.product-image-gallery.product-image-zoom img.gallery-image.visible')[0].get_attribute('src')
            ...
            product_details['product_price'] = self.driver.find_elements_by_css_selector('p.special-price span.price')[0].text
            ...
            product_details['source'] = 'Shannoh'
