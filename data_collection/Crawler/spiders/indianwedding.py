...
class IndianWedding:
    def __init__(self):
        ...
        self.source_urls_col = 'indianwedding'  # Column name having the source URL's in CSV file
    ...
    def parse_items(self,source_url_list, taxonomy_list):
        try:
            ...
            for url,tax in zip(source_url_list,taxonomy_list):
                ...
                p_element = self.driver.find_elements_by_css_selector('div.iws_catalogzoom a')
                for e in p_element:
