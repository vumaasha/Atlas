...
class Flipkart:
    def __init__(self):
        ...
        self.source_urls_col = 'flipkart'  # Column name having the source URL's in CSV file
    ...
    def parse_items(self,source_url_list, taxonomy_list):
        try:
            ...
            for url,tax in zip(source_url_list,taxonomy_list):
                self.driver.get(url)
                # p_element = self.driver.find_elements_by_css_selector('div.bhgxx2.col-12-12 div._3liAhj._1R0K0g a.Zhf2z-')
                p_element = self.driver.find_elements_by_css_selector('div.bhgxx2.col-12-12 div._2LFGJH a._2mylT6')
                for e in p_element:
