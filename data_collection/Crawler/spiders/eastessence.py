...
class EastEssence:
    def __init__(self):
        ...
        self.source_urls_col = 'eastessence'  # Column name having the source URL's in CSV file
    ...
    def parse_items(self,source_url_list, taxonomy_list):
        try:
            ...
            for url,tax in zip(source_url_list,taxonomy_list):
                ...
                p_element = self.driver.find_elements_by_css_selector('a.product-grid-image')
                for e in p_element:
    ...
    def parse_product(self,each_url,taxonomy):
        try:
            ...
            web_image_url = self.driver.find_elements_by_css_selector('div#rondellCarousel img')[0].get_attribute('src')
            ...
            product_details['product_price'] = self.driver.find_elements_by_css_selector('span.price.on-sale')[0].text

            product_details['product_title'] = self.driver.find_elements_by_css_selector('header.product-title span.lang1')[0].text
