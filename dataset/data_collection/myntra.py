...
# class MyntraFashion:
#     def __init__(self):
#         self.input_csv_file = 'Sheet12.csv'  # csv file containing the taxonomy and website source URL's
...
#
#             file_path = "/home/et/Desktop/Atlas/DataCollection/images/"+taxonomy.replace("->","/") + "/" + self.source_urls_col + "/images/"
...
#             json_path = '/home/et/Desktop/Atlas/DataCollection/images/' + taxonomy.replace("->","/") + "/" + self.source_urls_col + '/'
